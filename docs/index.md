...
<div class="home-tiles-shell">
<div class="home-tiles-container">

<div class="guide-landing-grid">

<a class="guide-card" href="/guide/json-api">
  <span class="guide-card-label">Platform</span>
  <span class="guide-card-title">General Documentation</span>
  <span class="guide-card-desc">Central hub — start here for platform guides, APIs and webhooks, then branch into each embedding SDK.</span>
...
<a class="guide-card" href="https://expofp.github.io/expofp-sdk-ios/documentation/expofp/" target="_blank">
  <span class="guide-card-label">Native</span>
  <span class="guide-card-title">iOS</span>
  <span class="guide-card-desc">Swift SDK v5 — documentation and API reference for embedding ExpoFP on Apple platforms.</span>
  <span class="guide-card-cta">Open docs</span>
</a>

<a class="guide-card" href="https://expofp.github.io/expofp-fplan-android/" target="_blank">
  <span class="guide-card-label">Native</span>
...
<a class="guide-card" href="https://expofp.github.io/react-native-efp-sdk/" target="_blank">
  ...
  <span class="guide-card-desc">React Native SDK for ExpoFP maps, routing, and venue tooling in mobile apps.</span>
  <span class="guide-card-cta">Open docs</span>
</a>
